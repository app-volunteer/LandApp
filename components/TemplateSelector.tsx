...
{showImageNotice && (
  <div className="fixed top-4 sm:top-24 inset-x-4 sm:left-1/2 sm:-translate-x-1/2 sm:w-[90%] max-w-md sm:max-w-lg bg-amber-50 border-2 border-amber-200 rounded-xl sm:rounded-[2rem] shadow-2xl p-3 sm:p-6 z-[100] animate-fade-in flex flex-col gap-2.5 sm:gap-4">
